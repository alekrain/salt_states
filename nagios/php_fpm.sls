...
nagios_php_fpm_service:
  service.running:
    - name: php-fpm
    - enable: True
    - watch:
      - pkg: nagios_php_fpm_install_packages
      - file: nagios_php_fpm_ini_fix_pathinfo
      - file: nagios_php_fpm_www_conf_listen
      - file: nagios_php_fpm_www.conf_user
      - file: nagios_php_fpm_www.conf_group
      - file: nagios_php_fpm_www_conf_uncomment_owner
      - file: nagios_php_fpm_www_conf_uncomment_group
